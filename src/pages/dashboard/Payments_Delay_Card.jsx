...
const Payments_Delay_Card = () => {
  ...
  return (
    ...
    <h2 className="text-xl font-montserrat mb-2">Payments Delay (Slippage Metrics)</h2>
     ...
     <div
      ...
      <div className="overflow-y-auto h-36 " style={{ maxHeight: "150px" }}>
        ...
        <tr className="bg-gray-600 text-white">
          <th className="text-sm font-montserrat py-1 px-2 border-b">Item</th>
          <th className="text-sm font-montserrat py-1 px-2 border-b">Est. Count</th>
          <th className="text-sm font-montserrat py-1 px-2 border-b">Emp. Count</th>
          <th className="text-sm font-montserrat py-1 px-2 border-b">Delay By</th>
        </tr>
      </thead>
      <tbody>
          {tableData.map((row, index) => (
            <tr className="even:bg-white odd:bg-gray-300" key={index}>
              <td className="text-sm font-montserrat py-1 px-2 border-b font-bold">{items[index]}</td>
              <td className="text-sm font-montserrat py-1 px-2 border-b text-center">{row.Est}</td>
              <td className="text-sm font-montserrat py-1 px-2 border-b text-center">{row.Emp}</td>
              <td className="text-sm font-montserrat py-1 px-2 border-b text-center">{row.Delay} Days</td>
            </tr>
            ))}
          </tbody>
    </table>
